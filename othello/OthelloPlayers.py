...
class NNPlayer():
    def __init__(self, game, model_dir='./pretrained_models/othello/pytorch/', model_name='8x8_100checkpoints_best.pth.tar', temp=0, num_sims=50):
        n1 = NNet(game)
    ...
    def play(self, board):
        return np.argmax(self.mcts1.getActionProb(board, self.temp))
