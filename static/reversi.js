...
{
	if (region.cr.an === region.cI.an)
	{
		return 'on line ' + region.cr.an;
	}
	return 'on lines ' + region.cr.an + ' through ' + region.cI.an;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dv: 'hidden', dn: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dv: 'mozHidden', dn: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dv: 'msHidden', dn: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dv: 'webkitHidden', dn: 'webkitvisibilitychange' }
		: { dv: 'hidden', dn: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.dB, request.p, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cK: fragment, dw: host, cX: path, dH: port_, dI: protocol, c0: query};
	});
...
var $author$project$Main$GetModels = function (a) {
	return {$: 2, a: a};
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{dk: false, dm: r.dm, a6: r.a6, cL: r.cL, dB: r.dB, dS: r.dS, de: r.de, p: r.p}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{dm: $elm$http$Http$emptyBody, a6: r.a6, cL: _List_Nil, dB: 'GET', dS: $elm$core$Maybe$Nothing, de: $elm$core$Maybe$Nothing, p: r.p});
};
var $elm$json$Json$Decode$list = _Json_decodeList;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$modelTypesDecoder = $elm$json$Json$Decode$list($elm$json$Json$Decode$string);
var $author$project$Main$urlLink = F2(
	function (url, s) {
		var sprt = function () {
			var _v1 = url.dH;
			if (!_v1.$) {
				...
				return ':' + function () {
					if (prt === 8000) {
						...
						return $elm$core$String$fromInt(prt);
					}
				}();
			} else {
				return '';
...
var $author$project$Main$getModels = function (url) {
	return $elm$http$Http$get(
		{
			a6: A2($elm$http$Http$expectJson, $author$project$Main$GetModels, $author$project$Main$modelTypesDecoder),
			p: A2($author$project$Main$urlLink, url, 'get_models')
		});
};
...
var $author$project$Main$getWindowInfo = A2($elm$core$Task$perform, $author$project$Main$GotViewport, $elm$browser$Browser$Dom$getViewport);
var $rundis$elm_bootstrap$Bootstrap$Utilities$DomHelper$Area = F4(
	function (top, left, width, height) {
		return {dt: height, K: left, N: top, dW: width};
	});
...
var $rundis$elm_bootstrap$Bootstrap$Dropdown$initialState = {
	ao: A4($rundis$elm_bootstrap$Bootstrap$Utilities$DomHelper$Area, 0, 0, 0, 0),
	o: 2,
					...
					A2(
						...
						function (s) {
							return _Utils_update(
								s,
								{
									aH: $elm$core$Maybe$Just(vp.dg.dW)
								});
						},
						state));
			},
...
var $rundis$elm_bootstrap$Bootstrap$Navbar$initialState = function (toMsg) {
	var state = {I: $elm$core$Dict$empty, dt: $elm$core$Maybe$Nothing, f: 0, aH: $elm$core$Maybe$Nothing};
...
var $author$project$Main$GameState = F5(
	function (uuid, board, player, available_actions, last_move) {
		return {b5: available_actions, T: board, am: last_move, av: player, bZ: uuid};
	});
...
var $author$project$Main$startGame = F3(
	function (url, modelName, whoPlaying) {
		return $elm$http$Http$get(
			{
				a6: A2($elm$http$Http$expectJson, $author$project$Main$GotGame, $author$project$Main$gameDecoder),
				p: A2($author$project$Main$urlLink, url, 'start/' + (modelName + ('/' + whoPlaying)))
			});
	});
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		...
		var navbarCmd = _v1.b;
		return _Utils_Tuple2(
			{aU: _List_Nil, G: 0, a1: 'AZO', h: _List_Nil, W: '', cQ: key, z: '', bk: $rundis$elm_bootstrap$Bootstrap$Dropdown$initialState, aq: navbarState, ar: 0, as: 'AZO', bD: $rundis$elm_bootstrap$Bootstrap$Dropdown$initialState, C: _List_Nil, p: url, aG: 0, aH: 0},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						$author$project$Main$getWindowInfo,
						navbarCmd,
						A3($author$project$Main$startGame, url, 'AZO', 'o'),
						$author$project$Main$getModels(url)
					])));
	});
var $author$project$Main$AZToggleMsg = function (a) {
	return {$: 10, a: a};
};
var $author$project$Main$GotNewDims = F2(
	function (a, b) {
		return {$: 16, a: a, b: b};
	});
var $author$project$Main$PlayingToggleMsg = function (a) {
	return {$: 12, a: a};
};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {cj: oldTime, c3: request, c9: subs};
	});
...
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2($rundis$elm_bootstrap$Bootstrap$Dropdown$subscriptions, model.bk, $author$project$Main$AZToggleMsg),
				A2($rundis$elm_bootstrap$Bootstrap$Dropdown$subscriptions, model.bD, $author$project$Main$PlayingToggleMsg),
				$elm$browser$Browser$Events$onResize(
				F2(
					function (w, h) {
						return A2($author$project$Main$GotNewDims, w, h);
					})),
				A2($rundis$elm_bootstrap$Bootstrap$Navbar$subscriptions, model.aq, $author$project$Main$NavbarMsg)
			]));
};
var $author$project$Main$MakeMove = function (a) {
	return {$: 4, a: a};
};
var $author$project$Main$GotHint = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$hintDecoder = A2($elm$json$Json$Decode$field, 'last_move', $elm$json$Json$Decode$string);
var $author$project$Main$getHint = F2(
	function (url, gameState) {
		var board = A2($elm$core$String$join, '', gameState.T);
		return $elm$http$Http$get(
			{
				a6: A2($elm$http$Http$expectJson, $author$project$Main$GotHint, $author$project$Main$hintDecoder),
				p: A2($author$project$Main$urlLink, url, 'get_action/' + (gameState.bZ + ('/' + (board + ('/' + gameState.av)))))
			});
	});
...
var $author$project$Main$makeMove = F3(
	function (url, gameState, action_string) {
		var board = A2($elm$core$String$join, '', gameState.T);
		return $elm$http$Http$get(
			{
				a6: A2($elm$http$Http$expectJson, $author$project$Main$GotGame, $author$project$Main$gameDecoder),
				p: A2($author$project$Main$urlLink, url, 'step_play/' + (gameState.bZ + ('/' + (board + ('/' + (gameState.av + ('/' + action_string)))))))
			});
	});
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$performMessage = function (msg) {
	return A2(
		$elm$core$Task$perform,
		$elm$core$Basics$identity,
		$elm$core$Task$succeed(msg));
};
var $author$project$Main$playingToString = function (playing) {
	if (!playing) {
		return 'o';
	} else {
		return 'x';
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 3:
				var action_string = msg.a;
				var _v1 = $elm$core$String$length(action_string);
				if (_v1 === 2) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{z: action_string}),
						$author$project$Main$performMessage(
							$author$project$Main$MakeMove(action_string)));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 4:
				var action_string = msg.a;
				var _v2 = $elm$core$String$length(action_string);
				if (_v2 === 2) {
					var _v3 = $elm$core$List$head(model.h);
					if (!_v3.$) {
						var gameState = _v3.a;
						return _Utils_Tuple2(
							model,
							A3($author$project$Main$makeMove, model.p, gameState, action_string));
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				} else {
				...
				if (!result.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								h: A2($elm$core$List$cons, rval, model.h),
								W: '',
								z: '',
								C: _List_Nil
							}),
			...
			case 9:
				...
				if (_v7.b) {
					...
					return _Utils_Tuple2(
						model,
						A3($author$project$Main$makeMove, model.p, gameState, 'xx'));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 6:
				...
				if (_v8.b) {
					var h = _v8.a;
					var t = _v8.b;
					return ($elm$core$List$length(t) > 0) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{
								h: t,
								C: A2($elm$core$List$cons, h, model.C)
							}),
				...
				if (_v9.b) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								h: A2($elm$core$List$cons, h, model.h),
								C: t
							}),
						$elm$core$Platform$Cmd$none);
				} else {
			...
			case 13:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 5:
				var newPlayer = $author$project$Main$playingToString(model.ar);
				var newModelName = model.as;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{G: model.ar, a1: model.as, h: _List_Nil, z: '', C: _List_Nil}),
					A3($author$project$Main$startGame, model.p, newModelName, newPlayer));
			case 14:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 15:
				var url = msg.a;
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 8:
				var _v10 = $elm$core$List$head(model.h);
				if (!_v10.$) {
					var gameState = _v10.a;
					return _Utils_Tuple2(
						model,
						A2($author$project$Main$getHint, model.p, gameState));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 16:
			...
			case 17:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aG: $elm$core$Basics$round(vp.dg.dt),
							aH: $elm$core$Basics$round(vp.dg.dW)
						}),
					$elm$core$Platform$Cmd$none);
			case 18:
				var state = msg.a;
...
var $author$project$Main$Hint = {$: 8};
var $author$project$Main$NewGame = {$: 5};
var $author$project$Main$NoMoveContinue = {$: 9};
var $author$project$Main$PlayingMsg = function (a) {
	return {$: 13, a: a};
};
var $author$project$Main$Redo = {$: 7};
var $author$project$Main$Undo = {$: 6};
...
var $author$project$Main$applyAction = F3(
	function (board, action, cell_value) {
		var y = action.b - 1;
		var x = action.a - 1;
		var t = A2($elm$core$List$drop, x + 1, board);
		var r = A2(
			$elm$core$Maybe$withDefault,
			'',
			$elm$core$List$head(
				A2($elm$core$List$drop, x, board)));
		var new_r = _Utils_ap(
			A2($elm$core$String$left, y, r),
			_Utils_ap(
				cell_value,
				A2(
					$elm$core$String$right,
					$elm$core$String$length(r) - (y + 1),
					r)));
		var h = A2($elm$core$List$take, x, board);
		return _Utils_ap(
			h,
			A2($elm$core$List$cons, new_r, t));
	});
...
var $author$project$Main$convertAction = function (s) {
	var l = $elm$core$String$toList(s);
	var xc = A2(
		$elm$core$Maybe$withDefault,
		'0',
		$elm$core$List$head(
	...
	var x = $elm$core$Char$toCode(xc) - $elm$core$Char$toCode('0');
	var yc = A2(
		$elm$core$Maybe$withDefault,
		'0',
		$elm$core$List$head(l));
	var y = ($elm$core$Char$toCode(yc) - $elm$core$Char$toCode('a')) + 1;
	return _Utils_Tuple2(x, y);
};
var $author$project$Main$convertBoard = F2(
	function (board, actions) {
		convertBoard:
		while (true) {
			var _v0 = $elm$core$List$head(actions);
			if (!_v0.$) {
				var a = _v0.a;
				var $temp$board = A3($author$project$Main$applyAction, board, a, '*'),
					$temp$actions = A2(
					$elm$core$Maybe$withDefault,
					_List_Nil,
					$elm$core$List$tail(actions));
				board = $temp$board;
				actions = $temp$actions;
				continue convertBoard;
			} else {
				return board;
			}
		}
	});
var $author$project$Main$addAvailableActions = function (gameState) {
	var num_actions = A2($elm$core$List$map, $author$project$Main$convertAction, gameState.b5);
	var action_board = A2($author$project$Main$convertBoard, gameState.T, num_actions);
	var action_board2 = function () {
		var _v0 = gameState.am;
		switch (_v0) {
			case 'zz':
				return action_board;
			case 'zx':
			...
			default:
				return A3(
					...
					action_board,
					$author$project$Main$convertAction(gameState.am),
					'+');
		}
	}();
	return action_board2;
};
...
var $rundis$elm_bootstrap$Bootstrap$Table$Bordered = {$: 2};
...
var $rundis$elm_bootstrap$Bootstrap$Grid$col = F2(
	function (options, children) {
		return $rundis$elm_bootstrap$Bootstrap$Grid$Column(
			{cD: children, dG: options});
	});
var $author$project$Main$computeDim = function (dim) {
	return 'calc(' + ($elm$core$String$fromInt(dim) + 'px)');
};
	...
	return {
		...
		dG: {
			...
			bR: $elm$core$Maybe$Just(
				{
					aV: $rundis$elm_bootstrap$Bootstrap$Navbar$Roled(6),
					bl: 1
				}),
			ay: 0
		},
...
var $rundis$elm_bootstrap$Bootstrap$Navbar$dropdownToggle = F2(
	function (attributes, children) {
		return {aS: attributes, cD: children};
	});
...
var $author$project$Main$AZModelMsg = function (a) {
	return {$: 11, a: a};
};
...
var $author$project$Main$navbarModelDropdown = function (m) {
	return A2(
		$rundis$elm_bootstrap$Bootstrap$Navbar$dropdownItem,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Main$AZModelMsg(m))
			]),
		_List_fromArray(
			[
...
var $rundis$elm_bootstrap$Bootstrap$Table$inversedHead = $rundis$elm_bootstrap$Bootstrap$Table$InversedHead;
var $author$project$Main$Play = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$blackPieceColor = 'black';
...
var $author$project$Main$cellColor = 'olive';
var $elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var $elm$html$Html$Attributes$style = $elm$virtual_dom$VirtualDom$style;
var $author$project$Main$cellBackground = $rundis$elm_bootstrap$Bootstrap$Table$cellAttr(
	A2($elm$html$Html$Attributes$style, 'background-color', $author$project$Main$cellColor));
var $author$project$Main$cellLastPlayedColor = 'tan';
var $author$project$Main$cellLastPlayed = $rundis$elm_bootstrap$Bootstrap$Table$cellAttr(
	A2($elm$html$Html$Attributes$style, 'background-color', $author$project$Main$cellLastPlayedColor));
var $elm$svg$Svg$trustedNode = _VirtualDom_nodeNS('http://www.w3.org/2000/svg');
var $elm$svg$Svg$circle = $elm$svg$Svg$trustedNode('circle');
var $elm$core$Char$fromCode = _Char_fromCode;
var $elm$core$String$fromList = _String_fromList;
var $author$project$Main$coordToAction = F2(
	function (x, y) {
		var yc = $elm$core$Char$fromCode(
			$elm$core$Char$toCode('a') + y);
		var xc = $elm$core$String$toList(
			$elm$core$String$fromInt(x + 1));
		return $elm$core$String$fromList(
			A2($elm$core$List$cons, yc, xc));
	});
var $elm$svg$Svg$Attributes$cx = _VirtualDom_attribute('cx');
var $elm$svg$Svg$Attributes$cy = _VirtualDom_attribute('cy');
var $elm$svg$Svg$Attributes$fill = _VirtualDom_attribute('fill');
var $elm$svg$Svg$Attributes$height = _VirtualDom_attribute('height');
var $author$project$Main$hintCellColor = 'skyblue';
...
var $author$project$Main$playableCellColor = 'silver';
...
var $author$project$Main$whitePieceColor = '#E0E0E0';
var $elm$svg$Svg$Attributes$width = _VirtualDom_attribute('width');
var $author$project$Main$boardChar = F4(
	function (playing, x, y, c) {
		var lastOpponentColor = function () {
			if (!playing) {
				return $author$project$Main$whitePieceColor;
			} else {
				return $author$project$Main$blackPieceColor;
			}
		}();
		var label = A2($author$project$Main$coordToAction, x, y);
		var color = function () {
			switch (c) {
				case 'o':
					return $author$project$Main$blackPieceColor;
				case 'x':
					return $author$project$Main$whitePieceColor;
				case '+':
					return lastOpponentColor;
				case '*':
					return $author$project$Main$playableCellColor;
				case '$':
					return $author$project$Main$hintCellColor;
				default:
					return $author$project$Main$cellColor;
			}
		}();
		var piece = function () {
			switch (c) {
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$Main$Play(label))
									]),
								_List_Nil)
							]));
				case '$':
			...
			switch (c) {
				...
				case '$':
					return $rundis$elm_bootstrap$Bootstrap$Table$cellAttr(
						A2($elm$html$Html$Attributes$style, 'background-color', color));
				case '+':
					return $author$project$Main$cellLastPlayed;
				default:
					return $author$project$Main$cellBackground;
			}
		}();
		return A2(
...
var $rundis$elm_bootstrap$Bootstrap$Table$cellDark = $rundis$elm_bootstrap$Bootstrap$Table$RoledCell(
	$rundis$elm_bootstrap$Bootstrap$Table$Roled(7));
...
var $author$project$Main$boardRow = F3(
	function (playing, index, s) {
		var boardChar1 = A2($author$project$Main$boardChar, playing, index);
		return A2(
...
var $author$project$Main$boardTable = F2(
	function (l, playing) {
		return A2(
			$elm$core$List$indexedMap,
			$author$project$Main$boardRow(playing),
			l);
	});
...
var $rundis$elm_bootstrap$Bootstrap$Table$tbody = F2(
	function (attributes, rows) {
		return $rundis$elm_bootstrap$Bootstrap$Table$TBody(
			{aS: attributes, bQ: rows});
	});
var $author$project$Main$reTbody = F4(
	function (board, playing, width, height) {
		var widthVal = $author$project$Main$computeDim(width);
		var heightVal = $author$project$Main$computeDim(height);
		return A2(
			$rundis$elm_bootstrap$Bootstrap$Table$tbody,
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$style, 'height', heightVal),
					A2($elm$html$Html$Attributes$style, 'width', widthVal)
				]),
			A2($author$project$Main$boardTable, board, playing));
	});
...
var $author$project$Main$headRow = function (c) {
	return A2(
...
var $rundis$elm_bootstrap$Bootstrap$Table$thead = F2(
	function (options, rows) {
		return {dG: options, bQ: rows};
	});
var $author$project$Main$reThead = function (options) {
	return A2(
			...
			if (!_v0.b.$) {
				...
				return $rundis$elm_bootstrap$Bootstrap$Table$TBody(
					_Utils_update(
						body,
						{
							bQ: A2($elm$core$List$map, $rundis$elm_bootstrap$Bootstrap$Table$mapInversedRow, body.bQ)
						}));
			} else {
...
var $rundis$elm_bootstrap$Bootstrap$Table$maybeMapInversedTHead = F2(
	function (isTableInversed, _v0) {
		...
		return (isTableInversed || isHeadInversed) ? _Utils_update(
			thead_,
			{
				bQ: A2($elm$core$List$map, $rundis$elm_bootstrap$Bootstrap$Table$mapInversedRow, thead_.bQ)
			}) : thead_;
	});
...
var $rundis$elm_bootstrap$Bootstrap$Table$renderCell = function (cell) {
	if (!cell.$) {
		var options = cell.a.dG;
		var children = cell.a.cD;
		return A2(
			$elm$html$Html$td,
		...
		A2(
			...
			_List_fromArray(
				[
					...
					A2($rundis$elm_bootstrap$Bootstrap$Table$maybeMapInversedTHead, isInversed, rec.dR)),
					$rundis$elm_bootstrap$Bootstrap$Table$renderTBody(
					A2($rundis$elm_bootstrap$Bootstrap$Table$maybeMapInversedTBody, isInversed, rec.dQ))
				])));
};
var $author$project$Main$reTable = F5(
	function (options, board, playing, width, height) {
		return $rundis$elm_bootstrap$Bootstrap$Table$table(
			{
				dG: options,
				dQ: A4($author$project$Main$reTbody, board, playing, width, height),
				dR: $author$project$Main$reThead(
					_List_fromArray(
						[$rundis$elm_bootstrap$Bootstrap$Table$inversedHead]))
			});
	});
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$Col = 0;
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$Width = F2(
	function (screenSize, columnCount) {
		return {cE: columnCount, c7: screenSize};
	});
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$colWidthClass = function (_v0) {
	var screenSize = _v0.c7;
	var columnCount = _v0.cE;
	return $elm$html$Html$Attributes$class(
		'col' + (A2(
			$elm$core$Maybe$withDefault,
			'',
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$defaultColOptions = {aL: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, aN: $elm$core$Maybe$Nothing, aO: $elm$core$Maybe$Nothing, aP: $elm$core$Maybe$Nothing, aS: _List_Nil, bm: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bo: $elm$core$Maybe$Nothing, bq: $elm$core$Maybe$Nothing, br: $elm$core$Maybe$Nothing, bx: $elm$core$Maybe$Nothing, by: $elm$core$Maybe$Nothing, bz: $elm$core$Maybe$Nothing, bA: $elm$core$Maybe$Nothing, bB: $elm$core$Maybe$Nothing, bE: $elm$core$Maybe$Nothing, bF: $elm$core$Maybe$Nothing, bG: $elm$core$Maybe$Nothing, bH: $elm$core$Maybe$Nothing, bI: $elm$core$Maybe$Nothing, bJ: $elm$core$Maybe$Nothing, bK: $elm$core$Maybe$Nothing, bL: $elm$core$Maybe$Nothing, bM: $elm$core$Maybe$Nothing, bN: $elm$core$Maybe$Nothing, bV: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, aF: $elm$core$Maybe$Nothing};
	...
	return _Utils_ap(
		...
		_Utils_ap(
			$rundis$elm_bootstrap$Bootstrap$Grid$Internal$offsetsToAttributes(
				_List_fromArray(
					[options.br, options.bo, options.bn, options.bm, options.bq])),
			_Utils_ap(
...
var $rundis$elm_bootstrap$Bootstrap$Grid$renderCol = function (column) {
	switch (column.$) {
		case 0:
			var options = column.a.dG;
			var children = column.a.cD;
			return A2(
				$elm$html$Html$div,
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$defaultRowOptions = {aS: _List_Nil, a8: $elm$core$Maybe$Nothing, a9: $elm$core$Maybe$Nothing, ba: $elm$core$Maybe$Nothing, bb: $elm$core$Maybe$Nothing, bc: $elm$core$Maybe$Nothing, b_: $elm$core$Maybe$Nothing, b$: $elm$core$Maybe$Nothing, b0: $elm$core$Maybe$Nothing, b1: $elm$core$Maybe$Nothing, b2: $elm$core$Maybe$Nothing};
	...
	return _Utils_ap(
		...
		_Utils_ap(
			A2(
				...
				'align-items-',
				_List_fromArray(
					[options.b2, options.b0, options.b$, options.b_, options.b1])),
			_Utils_ap(
		...
		return A2(
			...
			function (opt) {
				return _Utils_update(
					...
					{
						bR: $elm$core$Maybe$Just(
							{aV: bgColor, bl: modifier})
					});
			},
			conf);
	});
var $rundis$elm_bootstrap$Bootstrap$Navbar$secondary = A2(
	$rundis$elm_bootstrap$Bootstrap$Navbar$scheme,
	0,
	$rundis$elm_bootstrap$Bootstrap$Navbar$Roled(1));
				...
				A2(
					...
					function (s) {
						return _Utils_update(
							s,
							{
								f: A2($rundis$elm_bootstrap$Bootstrap$Navbar$visibilityTransition, configRec.P, s.f)
							});
					},
					state)));
	});
...
var $rundis$elm_bootstrap$Bootstrap$Navbar$menuAttributes = F2(
	function (state, configRec) {
		...
		switch (visibility) {
			case 0:
				if (height.$ === 1) {
					return ((!configRec.P) || A2($rundis$elm_bootstrap$Bootstrap$Navbar$shouldHideMenu, state, configRec)) ? defaults : _List_fromArray(
						[
...
var $rundis$elm_bootstrap$Bootstrap$Navbar$menuWrapperAttributes = F2(
	function (state, confRec) {
		...
		var display = function () {
			if (height.$ === 1) {
				return ((!confRec.P) || A2($rundis$elm_bootstrap$Bootstrap$Navbar$shouldHideMenu, state, confRec)) ? 'flex' : 'block';
			} else {
				return 'flex';
			}
		}();
		switch (visibility) {
			...
			case 3:
				return styleBlock;
			default:
				return ((!confRec.P) || A2($rundis$elm_bootstrap$Bootstrap$Navbar$shouldHideMenu, state, confRec)) ? _List_fromArray(
					[
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2('container', options.bf)
					]))
			]),
		_Utils_ap(
			...
			A2(
				...
				function (s) {
					return _Utils_update(
						s,
						{
							I: A3($elm$core$Dict$insert, id, newStatus, s.I)
						});
				},
				state));
	});
			...
			_Utils_ap(
				_List_fromArray(
					[
						...
						$elm$json$Json$Decode$succeed(
							{
								A: A3($rundis$elm_bootstrap$Bootstrap$Navbar$toggleOpen, state, id, configRec),
								cn: true,
								ct: false
							}))
					]),
	...
	function (state, configRec, _v0) {
		...
		var needsDropup = A2(
			...
			A2(
				...
				configRec.dG.V));
		var isShown = A2($rundis$elm_bootstrap$Bootstrap$Navbar$getOrInitDropdownStatus, ddRec.cc, state) !== 2;
		return A2(
			$elm$html$Html$li,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A4($rundis$elm_bootstrap$Bootstrap$Navbar$renderDropdownToggle, state, ddRec.cc, configRec, ddRec.cx),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
...
var $rundis$elm_bootstrap$Bootstrap$Navbar$view = F2(
	function (state, conf) {
		...
		return A2(
			$elm$html$Html$nav,
			$rundis$elm_bootstrap$Bootstrap$Navbar$navbarAttributes(configRec.dG),
			_Utils_ap(
				$rundis$elm_bootstrap$Bootstrap$Navbar$maybeBrand(configRec.ad),
				_Utils_ap(
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									_Utils_ap(
										_List_fromArray(
											[
												A3($rundis$elm_bootstrap$Bootstrap$Navbar$renderNav, state, configRec, configRec.cg)
											]),
										$rundis$elm_bootstrap$Bootstrap$Navbar$renderCustom(configRec.a2)))
								]))
						]))));
	});
...
var $author$project$Main$view = function (model) {
	...
	var newGameTitle = $elm$html$Html$Attributes$title('Select model and color first');
	var gameState = function () {
		var _v4 = $elm$core$List$head(model.h);
		if (!_v4.$) {
			var gs = _v4.a;
			return gs;
		} else {
			return {b5: _List_Nil, T: _List_Nil, am: '', av: '', bZ: ''};
		}
	}();
	var continueButtonTitle = $elm$html$Html$Attributes$title('Active when you have no move');
	var continueButton = _Utils_eq(
		$author$project$Main$playingToString(model.G),
		gameState.av) ? A2(
		...
		_List_fromArray(
			[
				continueButtonTitle,
				A2($elm$html$Html$Attributes$style, 'background-color', 'red'),
				$elm$html$Html$Events$onClick($author$project$Main$NoMoveContinue)
			]),
		_List_fromArray(
			[
				$elm$html$Html$text('Cont')
		...
		A2(
			...
			_List_fromArray(
				[
					...
					{
						cc: 'ModelDropdown',
						cg: A2($elm$core$List$map, $author$project$Main$navbarModelDropdown, model.aU),
						cx: A2(
					...
					$rundis$elm_bootstrap$Bootstrap$Navbar$dropdown(
					{
						...
						cg: _List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick(
										$author$project$Main$PlayingMsg(1))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick(
										$author$project$Main$PlayingMsg(0))
									]),
								_List_fromArray(
									[
						...
						cx: A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Color Playing')
								]))
					}),
					$rundis$elm_bootstrap$Bootstrap$Navbar$dropdown(
					{
						...
						cg: _List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$Hint)
									]),
								_List_fromArray(
									[
			...
			A3(
				...
				$rundis$elm_bootstrap$Bootstrap$Navbar$secondary(
	...
	var boardx = $author$project$Main$addAvailableActions(gameState);
	var boardx1 = function () {
		var _v3 = model.W;
		if (_v3 === '') {
			return boardx;
		} else {
			return A3(
				$author$project$Main$applyAction,
				boardx,
				$author$project$Main$convertAction(model.W),
				'$');
		}
	}();
	var boardBaseDim = A2($elm$core$Basics$min, model.aG, model.aH);
	var boardHeight = $elm$core$Basics$round(boardBaseDim * 0.75);
	var boardWidth = $elm$core$Basics$round(boardBaseDim * 0.75);
	var board = function () {
		var _v1 = model.z;
		if (_v1 === '') {
			return boardx1;
		} else {
			var player_mark = function () {
				var _v2 = model.G;
				if (!_v2) {
					return 'o';
				} else {
			...
			return A3(
				$author$project$Main$applyAction,
				boardx1,
				$author$project$Main$convertAction(model.z),
				player_mark);
		}
	}();
	var table = A5(
		$author$project$Main$reTable,
		_List_fromArray(
			[
				...
				A2(
					$elm$html$Html$Attributes$style,
					'height',
					$author$project$Main$computeDim(boardHeight))),
				$rundis$elm_bootstrap$Bootstrap$Table$attr(
				A2(
					$elm$html$Html$Attributes$style,
					'width',
					$author$project$Main$computeDim(boardWidth)))
			]),
		board,
		model.G,
		boardWidth,
	...
	var b = A2($elm$core$String$join, '', gameState.T);
	var blackScore = $elm$core$String$length(
		A2(
			...
			b));
	var whiteScore = $elm$core$String$length(
		A2(
			$elm$core$String$filter,
			function (x) {
				return x === 'x';
			...
			b));
	var netScore = blackScore - whiteScore;
	var currentScoreText = function () {
		var _v0 = gameState.am;
		if (_v0 === 'zx') {
			return (netScore > 0) ? A2(
				$elm$html$Html$h4,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Game Over: Black Wins by '),
						$elm$html$Html$text(
						$elm$core$String$fromInt(netScore))
					])) : ((netScore < 0) ? A2(
				$elm$html$Html$h4,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Game Over: White Wins by '),
						$elm$html$Html$text(
						$elm$core$String$fromInt(-netScore))
					])) : A2(
				$elm$html$Html$h4,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Game Over: Tie')
					])));
		} else {
			return A2(
				$elm$html$Html$h4,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('White:'),
						$elm$html$Html$text(
						$elm$core$String$fromInt(whiteScore)),
						$elm$html$Html$text(' Black: '),
						$elm$html$Html$text(
						$elm$core$String$fromInt(blackScore))
					]));
		}
	}();
	var azModelName = model.a1;
	return {
		dm: _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'background-color', 'tan'),
						A2($elm$html$Html$Attributes$style, 'width', '100%'),
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(playingName),
														$elm$html$Html$text(' vs. ' + azModelName)
													]))
											]))
									])),
								tableGrid
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{dz: $author$project$Main$init, dD: $author$project$Main$UrlChanged, dE: $author$project$Main$LinkClicked, dP: $author$project$Main$subscriptions, dU: $author$project$Main$update, dV: $author$project$Main$view});
